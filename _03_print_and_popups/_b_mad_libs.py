...
if __name__ == '__main__':
    ...
    enter = simpledialog.askstring(title='Madlibs', prompt="enter an adjective")
    # Get the player to enter a type of liquid
    enter2 = simpledialog.askstring(title='Madlibs', prompt="enter a liquid")
    # Get the player to enter a body part
    enter3 = simpledialog.askstring(title='Madlibs', prompt="enter a body part")
    # Get the player to enter a verb
    enter4 = simpledialog.askstring(title='Madlibs', prompt="enter a verb")
    # Get the player to enter a place
    enter5 = simpledialog.askstring(title='Madlibs', prompt="enter a place")
    ...
    story = (
        "Piranhas are more "+ enter + "during the day, so cross the river at\n"
        "night. Piranhas are attracted to fresh "+ enter2 + " and will most\n"
        "likely take a bite out of your "+ enter3 + " if you "+ enter4 + ". Whatever\n"
        "you do, if you have an open wound, try to find another way to get "
        "back to the "+ enter5 + ". Good luck!"
    )
